...
class Translations
{
    ...
    /**
     * @var bool Si true les traductions seront téléchargées à chaque fois
     */
    private $_debugMode="";

    /**
     * Translations constructor.
     * @param $config_translations_csv_url
     * @param string $defaultLangCode La langue à utiliser par défaut
     * @param bool $debugMode si true les traductions seront téléchargées à chaque fois
     */
    public function __construct($config_translations_csv_url,$defaultLangCode="fr",$debugMode=false){
    ...
    public function translations(){
        if(!$this->_translations){
            ...
            if(!file_exists($jsonCache) || $this->_debugMode){
